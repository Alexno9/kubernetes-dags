...
if __name__ == '__main__':
    ...
    get_users_file = "s3a://owshq-processing-zone/files/users/*.json"
    get_business_file = "s3a://owshq-processing-zone/files/business/*.json"
    get_reviews_file = "s3a://owshq-processing-zone/files/reviews/*.json"
    ...
    df_join \
        ...
        .format("jdbc") \
        .mode("overwrite") \
        .option("url", "jdbc:postgresql://10.0.171.78:5433/owshq") \
